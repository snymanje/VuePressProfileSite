<template>
  <section id="contact" class="text-gray-700 body-font relative">
    <div>
      <div class="container mx-auto flex flex-col text-center w-full py-16 px-4">
    ...
    <div class="container px-2 pb-20 mx-auto flex sm:flex-no-wrap flex-wrap">
      <div
        class="lg:w-2/3 md:w-1/2 bg-gray-300 rounded-lg overflow-hidden sm:mr-10 p-0 sm:p-10 flex items-end justify-start relative"
      >
        <iframe
          width="100%"
          height="100%"
        ...
        ></iframe>
        <div class="bg-white relative flex flex-wrap py-6 shadow-lg rounded">
      ...
      >
        ...
        ></textarea>
        <button
          class="text-white bg-green-700 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg"
        >SEND</button>
      </div>
    </div>
  </section>
